...
function generateLHBank(ticket) {
    ...
    pObj.addText(`เรียน	กรรมการผู้จัดการธนาคารแลนด์ แอนด์ เฮ้าส์ เพื่อรายย่อย จำกัด (มหาชน)`, { font_face: "Cordia New", font_size: 15 });
    pObj.addLineBreak();
    pObj.addLineBreak();
    pObj.addLineBreak();
