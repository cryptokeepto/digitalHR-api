...
function generateSchengenTouristVisaApplication(ticket) {
    ...
    var pObj = docx.createP();
    pObj.addText(`This letter is submitted in support of <Title> ${ticket.owner.firstName} ${ticket.owner.lastName}’s application for a <Country> visa.`, { font_face: "Arial", font_size: 11 });
    ...
    var pObj = docx.createP();
    pObj.addText(`<Title> ${ticket.owner.firstName} ${ticket.owner.lastName} would like to take a leisure trip to <Country> and other <Country> countries during ${ticket.owner.periodOfVisit.from} to ${ticket.owner.periodOfVisit.to}. On completing the trip, <heshe> will return to resume <hisher> work with the Company.`, { font_face: "Arial", font_size: 11 });
...
module.exports = generateSchengenTouristVisaApplication;
